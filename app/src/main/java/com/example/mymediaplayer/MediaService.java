...
public class MediaService extends Service implements MediaPlayerCallback {
    ...
    public final static String ACTION_CREATE = "com.example.mymediaplayer.create";
    public final static String ACTION_DESTROY = "com.example.mymediaplayer.destroy";
    ...
    private void init() {
        ...
        AssetFileDescriptor afd = getApplicationContext().getResources().openRawResourceFd(R.raw.a);
        try {
